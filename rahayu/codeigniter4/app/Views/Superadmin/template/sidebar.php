<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <!-- Navbar -->
        <nav class="main-header navbar navbar-expand" style="background-color: #2060C2;">
            <!-- Left navbar links -->
            <ul class="navbar-nav">
                <li class="nav-item">
        ...
        <aside class="main-sidebar sidebar-primary elevation-4" style="position: fixed; top:0; background-color: #2060C2">
            <!-- Brand Logo -->
